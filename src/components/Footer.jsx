 ...
 <footer className=' bg-black'>
    <div className=" container max_width_1140 footer_padding_top footer_padding_bottom">
        <div className=" row justify-content-between">
            <div className=" col-12 col-sm-7 col-md-6 col-lg-5 flex-sm-nowrap d-flex flex-wrap gap-4 justify-content-between" data-aos="fade-down-right">
         ...
         <h2 className=' mb-0 font_size_6xl line_height_7xl text-white font_family_inter font_weight_900 mb-3 mb-md-4'>G<span className=' color_yellow'>G</span></h2>
            ...
            <div className=" col-12 col-sm-5 col-md-4 d-flex justify-content-start justify-content-sm-end mt-5 mt-sm-0 align-items-start"  data-aos="fade-down-left">
